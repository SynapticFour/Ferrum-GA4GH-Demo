...
.PHONY: help up up-with-infra down destroy smoke-syntax smoke-evidence smoke-evidence-strict
...
help:
	...
	@echo "  make smoke-syntax          Static checks (matches CI)"
	...
	@echo "Sibling Ferrum: export FERUM_SRC=… or FERRUM_SRC=… (alias)"
